...
public interface Execution {
    ...
    void addExecutionObserver(ExecutionObserver... o);


    void removeExecutionObserver(ExecutionObserver... o);

    /**
     * @return a List of execution observers which can be iterated safely, without causing ConcurrentModificationException
     */
    List<ExecutionObserver> getExecutionObservers();
}